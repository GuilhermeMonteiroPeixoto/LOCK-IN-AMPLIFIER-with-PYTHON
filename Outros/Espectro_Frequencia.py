...
plt.plot(data.iloc[:,0],linewidth=0.2)
plt.show()
...
plt.plot(freq[mascara],fft_abs[mascara],linewidth=0.2)
plt.xlim(0,150)
...
plt.plot(xf, 2.0/N*np.abs(yf[0:int(N/2)]),linewidth=0.2)
plt.xlim(0,150)
plt.ylim(0.00000, 0.00006)
plt.show()

#Metodo 3 - Usando matplotlib
plt.magnitude_spectrum(sinal, Fs=1/tx,linewidth=0.2)
plt.xlim(0,150)
plt.ylim(0.00000, 0.00006)
plt.show()
